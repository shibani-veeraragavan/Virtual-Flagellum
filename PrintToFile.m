...
%     block = [];
%     N  = Fil.N_w;
%     block = [repmat(t,N,1), Fil.X(1,1:N)', Fil.X(2,1:N)', Fil.X(3,1:N)', ...
%             Fil.Q(1:N,1), Fil.Q(1:N,2), Fil.Q(1:N,3), Fil.Q(1:N,4), ...
%             Fil.V(1,1:N)', Fil.V(2,1:N)', Fil.V(3,1:N)', ...
%             Fil.V(4,1:N)', Fil.V(5,1:N)', Fil.V(6,1:N)', ...
%             Fil.F(1,1:N)', Fil.F(2,1:N)', Fil.F(3,1:N)', ...
%             Fil.F(4,1:N)', Fil.F(5,1:N)', Fil.F(6,1:N)'];
%     dlmwrite(file,block,'-append');
        fprintf('\n');
        for j_w = 1:Fil.N_w
            if j_w == Fil.N_w
                L1 = 0;
            ...
            L1, L2, L3, FS(1,j_w), FS(2,j_w), FS(3,j_w));
        fprintf('\n');
        end
end