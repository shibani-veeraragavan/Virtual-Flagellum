function [filename, Filament, t] = main_Ani(a,DL_factor,Ns,SN,m_0,k_b,phi,mu,KB,KT,NB,NT,wall,dtfac,num_settling_times,datein,save_step,concheck_tol) %#codegen
